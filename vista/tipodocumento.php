...
<head>
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            //$("#txtTexto").focus();
            $("#mdRegistro").hide();
            $("#tituloLista").text("Listado de Tipo de Documentos");
            $("#tituloMantenimiento").text("Gestión de Tipo de Documentos");
            $("#identificador").val("Tipo de Documentos");
                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        for (var i = 0; i < data.length; i++) {
                            ...
                            $cuerpo += "<td>" + data[i].abreviatura_tdo + "</td>";
                            $cuerpo += "<td>" + data[i].codigosunat_tdo + "</td>";                             
                    ...
                    //console.log($cuerpo)
                    $("#tTipoDocumento").DataTable().destroy();
                    $("#tbTipoDocumento").html($cuerpo);
                    $("#tTipoDocumento").DataTable({
                        "processing": true,
                        'dom': 'Blfrtip',
                        'buttons': [
                            /*'copy',*/
        ...
        function Editar(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $("#txtAbreviatura_tdo").val(data[0].abreviatura_tdo);
                    $("#txtCodigoSunat_tdo").val(data[0].codigosunat_tdo);

                    // Configura el checkbox en función de la verificación
                    $("#chkCompra").prop('checked', data[0].tipo.includes('I'));
                    $("#chkVenta").prop('checked', data[0].tipo.includes('S'));
                    $("#chkCliente").prop('checked', data[0].tipo.includes('C'));
                    $("#chkProveedor").prop('checked', data[0].tipo.includes('P'));
        ...
        function fnLimpiar() {
            $("#hdcod").val("0");
            $("#txtNombre").val("");
            $("#txtAbreviatura_tdo").val("");
            $("#txtCodigoSunat_tdo").val("");
                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive" style="font-size: 11px;">
                                    <table id="tTipoDocumento" class="display compact order-column form-control-sm" style="width:98%;">
                                        <thead>
                                            <tr>
                                                <th style="width: 5%; text-align:center;">N°</th>
                                                <th style="width: 53%; text-align:center;">Nombre</th>
                                                <th style="width: 20%; text-align:center;">Abreviatura</th>                                                
                                                <th style="width: 10%; text-align:center;">Código Sunat</th>
                                                <th style="width: 10%; text-align:center;">Acción</th>
                                            </tr>
                                        </thead>
                                        <tbody id="tbTipoDocumento">
                                        </tbody>
                                    </table>
                                </div>
                            </div>
            ...
            <form id="frmRegistro">
                <div class="form-row mb-2 form-control-sm">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control form-control-sm" id="txtNombre" name="txtNombre" maxlength="30" />
                    </div>
                </div>

                <div class="form-row mb-2 form-control-sm">
                    <label for="txtAbreviatura_tdo" class="col-sm-3 col-form-label-sm" style="text-align:right">
                        Abreviatura: 
                    </label>
                    <div class="col-sm-2">
                        <input type="text" class="form-control form-control-sm" id="txtAbreviatura_tdo" name="txtAbreviatura_tdo" maxlength="10" />
                    </div>

                    <label for="txtCodigoSunat_tdo" class="col-sm-2 col-form-label-sm" style="text-align:right">
                        Código Sunat: 
                    </label>
                    <div class="col-sm-2">
                        <input type="text" class="form-control form-control-sm" id="txtCodigoSunat_tdo" name="txtCodigoSunat_tdo" maxlength="10" />
                    </div>
                </div>
                <hr> <!-- Línea horizontal -->
                <div class="form-row mb-2 form-control-sm">
                    <label for="lblDocCompra" class="col-sm-2 col-form-label-sm" style="text-align:right">
                        Doc. Compra: 
                    </label>
                    <div class="form-check" class="col-sm-2">
                        <input class="form-check-input" type="checkbox" id="chkCompra" name="chkCompra" value="1">
                    </div>
                
                    <label for="lblDocVenta" class="col-sm-2 col-form-label-sm" style="text-align:right">
                        Doc. Venta: 
                    </label>
                    <div class="form-check" class="col-sm-2">
                        <input class="form-check-input" type="checkbox" id="chkVenta" name="chkVenta" value="1">
                    </div>
                
                    <label for="lblDocCliente" class="col-sm-2 col-form-label-sm" style="text-align:right">
                        Doc. Cliente: 
                    </label>
                    <div class="form-check" class="col-sm-2">
                        <input class="form-check-input" type="checkbox" id="chkCliente" name="chkCliente" value="1">
                    </div>
                
                    <label for="lblDocProveedor" class="col-sm-2 col-form-label-sm" style="text-align:right">
                        Doc. Proveedor: 
                    </label>
                    <div class="form-check" class="col-sm-2">
                        <input class="form-check-input" type="checkbox" id="chkProveedor" name="chkProveedor" value="1">
                    </div>                    
                </div>
                <hr> <!-- Línea horizontal -->
