...
<head>
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            //$("#txtTexto").focus();
            $("#mdRegistro").hide();
            $("#tituloLista").text("Listado de Tipo de Persona");
            $("#tituloMantenimiento").text("Gestión de Tipo de Persona");
            $("#identificador").val("Tipo de Persona");
        ...
        function Listar() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    //console.log($cuerpo)
                    $("#tTipoPersona").DataTable().destroy();
                    $("#tbTipoPersona").html($cuerpo);
                    $("#tTipoPersona").DataTable({
                        "processing": true,
                        'dom': 'Blfrtip',
                        'buttons': [
                            /*'copy',*/
                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive" style="font-size: 11px;">
                                    <table id="tTipoPersona" class="display compact order-column form-control-sm" style="width:98%;">
                                        <thead>
                                            <tr>
