...
<head>
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            //$("#txtTexto").focus();
            $("#mdRegistro").hide();
            $("#tituloLista").text("Listado de Líneas");
            $("#tituloMantenimiento").text("Gestión de Líneas");
            $("#identificador").val("Línea");

            Listar();

            $("#cboServicioTecnico").select2();
            ListarcboServicioTecnico();
                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        for (var i = 0; i < data.length; i++) {
                            ...
                            $cuerpo += "<td>" + data[i].serviciotecnico + "</td>";
        ...
        function Guardar() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data[0].rpta == 0) {
                        msgAlerta('error', titulo, data[0].msj)
                    } else {
        ...
        function validar() {
            ...
            if ($("#txtNombre").val().trim() == "") {
                msgAlerta('error', 'Ingrese el nombre de la ' + $("#identificador").val(), titulo);
                $("#txtNombre").focus();
                return false;
            }
           
            if ($("#cboServicioTecnico").val().trim() == '0') {
                msgAlerta('error', 'Debe seleccionar si se usará en el Servicio Técnico de la ' + $("#identificador").val(), titulo);
                $("#cboServicioTecnico").focus();
                return false;
            }
        ...
        function Editar(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var $serviciotecnico = (data[0].serviciotecnico == 'SI') ? 'S' : 'N';
                    $("#cboServicioTecnico").val($serviciotecnico).trigger('change');
        ...
        function fnLimpiar() {
            $("#hdcod").val("0");
            $("#txtNombre").val("");
            $("#cboServicioTecnico").val("0").change();
        }
    </script>
</head>
                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <div class="table-responsive" style="font-size: 11px;">
                                    <table id="tLinea" class="display compact order-column form-control-sm" style="width:98%;">
                                        <thead>
                                            <tr>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-12">
                                                ...
                                                <form id="frmRegistro">
                                                    ...
                                                    <div class="form-row mb-2 form-control-sm">
                                                        <label for="lblcboServicioTecnico" class="col-sm-3 col-form-label-sm" style="text-align:right" >
                                                        Servicio Técnico: </label>
                                                        <div class="col-sm-4">
                                                            <select class="cboServicioTecnico form-control" style="width:200px" id="cboServicioTecnico" name="cboServicioTecnico"></select>
                                                        </div>
                                                    </div>
