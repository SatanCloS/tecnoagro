...
<head>
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("#tituloLista").text("Listado de Amortización a Proveedores");
            $("#tituloMantenimiento").text("Gestión de Amortización a Proveedores");
            $("#identificador").val(" Amortización a Proveedores");
        ...
        function Listar() { 
            $.ajax({
                url: "controlador/contAmortizacionProveedor.php",
                type: "POST",
                data: {
                    "accion": "Listar",
                    "cboTipo": $("#cboTipo").val(),
                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        for (var i = 0; i < data.length; i++) {
                            ...
                            $cuerpo += "<td align='right'>" + data[i].importe_mop + "</td>";  
                            $cuerpo += "<td align='right'>" + data[i].pago_mop + "</td>";  
                            $cuerpo += "<td align='right'>" + data[i].saldo_mop + "</td>";  
                            $cuerpo += "<td style='font-size:10px; text-align:center;'>";

                            if (data[i].tipo === 'P' && parseFloat(data[i].saldo_mop) > 0) {
        ...
        function validar() {
            ...
            if ($("#txtCodigo_pro").val().trim() == "") {
                msgAlerta('error', 'Ingrese un proveedor para el ' + $("#identificador").val(), titulo);
                $("#txtCodigo_pro").focus();
                return false;
            }
        ...
        function EditarDeuda(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $("#hdnumero_ser").val(data[0].serie_mop);
                    $("#hdnumero_doc").val(data[0].numero_mop);

                    var fechaActual = new Date();
                    var fechaFormato = fechaActual.toISOString().slice(0, 10);
                    $("#txtfecha_mop").val(fechaFormato);
                    ...
                    $("#txtDeuda_mop").val(data[0].importe_mop);
                    $("#txtSaldo_mop").val(data[0].saldo_mop);
        ...
        function EditarPago(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $("#txtRecibo_reg").val(data[0].recibo_mop);

                    $("#txtDolar_reg").val(data[0].dolar_mop);
                    $("#txtCodigo_pro").val(data[0].codigo_pro);
                    $("#txtProveedor").val(data[0].proveedor);
                    
                    $("#txtDeuda_mop").val(data[0].importe_ref);
                    $("#txtSaldo_mop").val(data[0].saldo_ref);
                    ...
                    $("#hdnumero_ser").val(data[0].serie_mop);
                    $("#hdnumero_doc").val(data[0].numero_mop);                  
                    $("#hdreferencia").val(data[0].referencia_mop);
                                    ...
                                    <table id="tCXC" class="display compact order-column form-control-sm" style="width:98%;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 33%; text-align:center;">Proveedor</th>
                                                ...
                                                <form id="frmRegistro">
                                                    ...
                                                    <div class="form-row mb-2 form-control-sm">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            <input type="text" style="text-align:left" class="form-control form-control-sm" id="txtProveedor" name="txtProveedor" maxlength="20" />
                                                        </div>

                                                    </div>

                                                    <div class="form-row mb-2 form-control-sm">
                                                        <label for="lblDeuda_mop" class="col-sm-3 col-form-label-sm" style="text-align:right" >
                                                            Deuda: </label>
                                                        <div class="col-sm-3">
                                                            <input type="number" style="text-align:right; font-weight: bold;" class="form-control form-control-sm" id="txtDeuda_mop" name="txtDeuda_mop" placeholder="0.00" maxlength="20" />
                                                        </div>
                                                        
                                                        <label for="lblSaldo_mop" class="col-sm-2 col-form-label-sm" style="text-align:right" >
                                                            Saldo: </label>
                                                        <div class="col-sm-3">
                                                           <input type="number" style="text-align:right; font-weight: bold;" class="form-control form-control-sm" id="txtSaldo_mop" name="txtSaldo_mop" placeholder="0.00" maxlength="20" />
                                                        </div>
