...
<head>
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            //$("#txtTexto").focus();
            $("#mdRegistro").hide();
            $("#mdListarGrupoConcepto").hide();
            $("#tituloLista").text("Listado de Conceptos");
            $("#tituloMantenimiento").text("Gestión de Conceptos");
            $("#identificador").val("Concepto");

            Listar();

            $("#cboGrupoConcepto").select2();
            ListarCboGrupoConcepto();
            ...
            $("#btnBuscarGrupoConcepto").click(function() {
                $("#Lista").hide();
                $("#mdRegistro").hide();
                $("#mdListarGrupoConcepto").show();
              
               ListarConcepto();
            });

            
            $("#btnCancelarGrupoConcepto").click(function() {
                $("#Lista").hide();
                $("#mdRegistro").show();
                $("#mdListarGrupoConcepto").hide();
                //$("#txtNombre").focus();
                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        for (var i = 0; i < data.length; i++) {
                            ...
                            $cuerpo += "<td>" + data[i].nombre_gco + "</td>";                         
                    ...
                    //console.log($cuerpo)
                    $("#tConcepto").DataTable().destroy();
                    $("#tbConcepto").html($cuerpo);
                    $("#tConcepto").DataTable({
                        "processing": true,
                        'dom': 'Blfrtip',
                        'buttons': [
        ...
        function ListarCboGrupoConcepto() {
            $.ajax({
        ...
        function validar() {
            ...
            if ($("#cboGrupoConcepto").val().trim() == '0') {
                msgAlerta('error', 'Debe seleccionar el grupo de concepto para el ' + $("#identificador").val(), titulo);
                $("#cboGrupoConcepto").focus();
                return false;
            }
            return true;
        ...
        function Editar(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $("#cboGrupoConcepto").val(data[0].codigo_gco).change();
                    //$("#txtGrupoConcepto").val(data[0].nombre_gco);
        ...
        //                     $cuerpo += "<td>" + data[i].nombre + "</td>";
        //                     $cuerpo += "<td style='font-size:10px; text-align:center;'>";
        //                     $cuerpo += "<button type='button' class='btn btn-info btn-sm btn-radius' onclick='EditarGrupoConcepto(" + data[i].codigo + ")' title='Editar' >  <i class='fas fa-check small'></i> </i></button>";
        //                     $cuerpo += "</td>";
        //                     $cuerpo += "</tr>";                        
        //                 }
        //             }
        //             //console.log($cuerpo)
        //             $("#tListadoGrupoConcepto").DataTable().destroy();
        //             $("#tbListadoGrupoConcepto").html($cuerpo);
        //             $("#tListadoGrupoConcepto").DataTable({
        //                 "processing": true,
        //                 'dom': 'Blfrtip',
        //                 'buttons': [
        //                     /*'copy',*/
        ...
        // function EditarGrupoConcepto(id) {
        //     //console.log(id);
        //     //loading(true);
        //     //fnLimpiar();
        //     //$("#frmRegistro").addClass("was-validated");
        ...
        //         success: function(data) {
        //             var data = JSON.parse(data);
        //             $("#txtCodigo_gco").val(data[0].codigo);
        //             $("#txtGrupoConcepto").val(data[0].nombre);
    ...
    <div class="wrapper">
        ...
        <section class="content pt-2">
            <div class="container-fluid">
                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive" style="font-size: 11px;">
                                    <table id="tConcepto" class="display compact order-column form-control-sm" style="width:98%;">
                                        <thead>
                                            <tr>
                                            ...
                                            <div class="col-sm-12 col-md-12" >
                                                ...
                                                <form id="frmRegistro">
                                                    ...
                                                    <!-- <div class="form-row mb-2">
                                                        <label for="txtCodigo_gco" class="col-sm-3 col-form-label-sm" style="text-align:right" >
                                                            Grupo Concepto: </label>
                                                        <div class="col-sm-2">
                                                           <input type="text" class="form-control form-control-sm" id="txtCodigo_gco" name="txtCodigo_gco" maxlength="2" />
                                                        </div>
                                                    </div> -->

                                                    <!-- <div class="form-row mb-2 form-control-sm">
                                                        <label for="txtLinea" class="col-sm-3 col-form-label-sm" style="text-align:right" >
                                                        Grupo Concepto: </label>
                                                        <div class="col-sm-1" style="text-align: center;">
                                                            <input type="hidden" id="txtCodigo_gco" name="txtCodigo_gco" value="0">
                                                            <button type="button" id="btnBuscarGrupoConcepto" class="btn btn-sm  btn-outline-success">
                                                                <i class="fas fa-search-plus"></i></button>
                                                        </div>
                                                        <div class="col-sm-5">
                                                            <input type="text" class="form-control form-control-sm" id="txtGrupoConcepto" name="txtGrupoConcepto"  maxlength="100" readonly />
                                                        </div>
                                                    </div> -->

                                                    <div class="form-row mb-2 form-control-sm">
                                                        <label for="lblGrupoConcepto" class="col-sm-3 col-form-label-sm" style="text-align:right" >
                                                            Grupo de Concepto: </label>
                                                        <div class="col-sm-4">
                                                            <select class="cboGrupoConcepto form-control" style="width:435px" id="cboGrupoConcepto" name="cboGrupoConcepto"></select>
                                                        </div>
                                                    </div>
                ...
                <div class="row" id="mdListarGrupoConcepto">
                    <div class="container">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-xl-8 col-md-8 col-lg-8">
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 col-md-12">
                                                <form id="frmListadoGrupoConcepto">
                                                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                                        <div class="col-sm-8 text-left">
                                                            <h5 class="m-0" id="tituloLista">Listado de Grupo de Concepto</h5>
                                                        </div>
                                                        <div class="col-sm-4 text-right">
                                                            <button type="button" id="btnCancelarGrupoConcepto" class="btn btn-sm btn-danger btn-radius">
                                                                <i class="fa fa-times-circle"></i>&nbsp;Cancelar</button>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="table-responsive" style="font-size: 11px;">
                                                            <table id="tListadoGrupoConcepto" class="display compact order-column form-control-sm" style="width:98%;">
                                                                <thead>
                                                                    <tr>
                                                                        <th style="width: 5%; text-align:center;">
                                                                            N°
                                                                ...
                                                                <tbody id="tbListadoGrupoConcepto">
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                    </div>
