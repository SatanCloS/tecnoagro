...
<head>
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            //$("#txtTexto").focus();
            $("#mdRegistro").hide();
            $("#tituloLista").text("Listado de Bancos");
            $("#tituloMantenimiento").text("Gestión de Bancos");
            $("#identificador").val("Banco");
                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        for (var i = 0; i < data.length; i++) {
                            ...
                            $cuerpo += "<td>" + data[i].abreviatura_ban + "</td>";                         
        ...
        function Editar(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $("#txtAbreviatura_ban").val(data[0].abreviatura_ban);
                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive" style="font-size: 11px;">
                                    <table id="tBanco" class="display compact order-column form-control-sm" style="width:98%;">
                                        <thead>
                                            <tr>
                                                <th style="width: 5%; text-align:center;">
                                                    N°
                                                </th>
                                                <th style="width: 63%; text-align:center;">
                                                    Nombre
                                                </th>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-12" >
                                                ...
                                                <form id="frmRegistro">
                                                    ...
                                                    <div class="form-row mb-2 form-control-sm">
                                                        <label for="txtAbreviatura_ban" class="col-sm-3 col-form-label-sm" style="text-align:right" >
                                                            Abreviatura: </label>
                                                        <div class="col-sm-2">
                                                           <input type="text" class="form-control form-control-sm" id="txtAbreviatura_ban" name="txtAbreviatura_ban" maxlength="10" />
                                                        </div>
                                                    </div>
