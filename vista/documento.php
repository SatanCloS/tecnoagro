...
<head>
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            //$("#txtTexto").focus();
            $("#mdRegistro").hide();
            $("#tituloLista").text("Listado de Documentos");
            $("#tituloMantenimiento").text("Gestión de Documentos");
                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        for (var i = 0; i < data.length; i++) {
                            ...
                            $cuerpo += "<td>" + data[i].codigosunat + "</td>";                         
                    ...
                    //console.log($cuerpo)
                    $("#tDocumento").DataTable().destroy();
                    $("#tbDocumento").html($cuerpo);
                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive" style="font-size: 11px;">
                                    <table id="tDocumento" class="display compact order-column form-control-sm" style="width:98%;">
                                        <thead>
                                            <tr>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-12" >
                                                ...
                                                <form id="frmRegistro">
                                                    ...
                                                    <div class="form-row mb-2">
                                                        <label for="txtCodigoSunat" class="col-sm-3 col-form-label-sm" style="text-align:right" >
                                                            Código Sunat: </label>
                                                        <div class="col-sm-2">
                                                           <input type="text" class="form-control form-control-sm" id="txtCodigoSunat" name="txtCodigoSunat" maxlength="2" />
                                                        </div>
                                                    </div>
