...
class ClsCompra
{
    function Listar($tipo, $codigo_com, $fecha_ini, $fecha_fin, $codigo_pro, $codigo_suc)
    {
        try {
            $ocado = new conexion();
            $sql = "call ListarCompra(:tipo,:codigo_com,:fecha_ini,:fecha_fin,:codigo_pro,:codigo_suc);";            
            //echo $sql;
            //echo var_dump($sql);
            $parametros = array(
                ':tipo' => $tipo,
